...
- [/] Bot Ownership Isolation
    - [ ] Backend: Implement `get_current_user` & `X-User-Email` check <!-- id: 42 -->
    - [ ] Backend: Filter `list_bots` by user email <!-- id: 43 -->
    - [ ] Frontend: Pass `user.email` in Fetch Bots headers <!-- id: 44 -->
    - [ ] DB Migration: Update existing bots to have owner (if needed) <!-- id: 45 -->
