...
// const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || "https://session-api-1088865818405.us-central1.run.app";
const API_BASE_URL = "https://session-api-1088865818405.us-central1.run.app";
