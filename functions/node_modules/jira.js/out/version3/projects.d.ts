...
export declare class Projects {
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg).
     */
    getNotificationSchemeForProject<T = Models.NotificationScheme>(parameters: Parameters.GetNotificationSchemeForProject, callback: Callback<T>): Promise<void>;
    /**
     * Gets a [notification scheme](https://confluence.atlassian.com/x/8YdKLg) associated with the project.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg).
     */
    getNotificationSchemeForProject<T = Models.NotificationScheme>(parameters: Parameters.GetNotificationSchemeForProject, callback?: never): Promise<T>;
}
