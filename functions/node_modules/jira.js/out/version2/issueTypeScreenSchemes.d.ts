...
export declare class IssueTypeScreenSchemes {
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteIssueTypeScreenScheme<T = void>(parameters: Parameters.DeleteIssueTypeScreenScheme | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes an issue type screen scheme.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteIssueTypeScreenScheme<T = void>(parameters: Parameters.DeleteIssueTypeScreenScheme | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getProjectsForIssueTypeScreenScheme<T = Models.PageProjectDetails>(parameters: Parameters.GetProjectsForIssueTypeScreenScheme | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of
     * projects associated with an issue type screen scheme.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getProjectsForIssueTypeScreenScheme<T = Models.PageProjectDetails>(parameters: Parameters.GetProjectsForIssueTypeScreenScheme | string, callback?: never): Promise<T>;
}
